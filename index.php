...
<head>
  ...
  <!-- 阿部さんcss -->
  <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/assets/css/style_sample.css">
...
<body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
  <main>
    ...
    <!-- レンタル会議室 -->
    <h1>レンタル会議室</h1>
    <p>1時間あたり1,200円からご案内しています。</p>
    <div class="img">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/meeting-room/IT.JPG" alt="IT-room">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/meeting-room/meeting-roomA.JPG" alt="meeting-roomA">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/meeting-room/meeting-roomB.JPG" alt="meeting-roomB">
    </div>


    <!-- レンタルオフィス -->
    <h1>レンタルオフィス</h1>
    <p>レンタルオフィスは北谷町役場商工観光課より公募という形で募集をおこないます</p>
    <div class="img">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/meeting-room/office-roomA.JPG" alt="office-roomA">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/meeting-room/office-roomB.JPG" alt="office-roomB">
      <img src="<?php echo get_template_directory_uri(); ?>/sets/images/meeting-room/office-roomC.JPG" alt="office-roomC">
    </div>


    <!-- レンタル器材 -->
    <section class="module" id="rental">
      <h2 class="subtitle">レンタル機材</h2>
      ...
      <ul class="works-grid works-grid-gut works-grid-3 works-hover-w" id="works-grid work-item">
        <li class="work-item"><a href="portfolio-single-1.html">
          <div class="work-image"><img src="https://placehold.jp/311.33px383.png" alt="Portfolio Item"/></div>
